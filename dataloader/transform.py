...
class ResizePad:
    """
    Resizes a PIL image to a given size
    """

    def __init__(self, target_size: int, interpolation: str = 'bilinear', rgb_fill_color: tuple = (0, 0, 0),
                 thermal_fill_color: tuple = (0, 0, 0)):
...
class RandomResizePad:
    """
    Randomly resizes a PIL image to a given size
    """
...
class RandomFlip:
    """
    Randomly flips a given PIL image to a given size
    """
...
class Compose:
    """
    Composes several transforms together (thermal and rgb images)
    """
...
def transforms_eval(
    ...
    rgb_fill_color, thermal_fill_color = resolve_fill_color(fill_color, rgb_mean), resolve_fill_color(fill_color,
                                                                                                      thermal_mean)

    image_tfl = [
        ResizePad(
            target_size=img_size, interpolation=interpolation, rgb_fill_color=rgb_fill_color,
            thermal_fill_color=thermal_fill_color),
        ImageToNumpy(),
    ]
